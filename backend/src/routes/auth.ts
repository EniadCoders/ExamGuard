...
// POST /login/2fa : étape 2 de la connexion, vérification du code 2FA.
...
// POST /2fa/setup : génère un secret + QR code à scanner.
...
// POST /2fa/enable : confirme le secret avec un code et active la 2FA.
...
// POST /2fa/disable : désactive la 2FA après vérification d'un code.
