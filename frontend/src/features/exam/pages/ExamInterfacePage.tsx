...
export function ExamInterface() {
  ...
  const isAnswered = useCallback(
    (idx: number): boolean => {
      ...
      if (q.type === "text") return typeof a === "string" && (a as string).trim().length > 0;
      if (q.type === "code") {
                      ...
                      <button
                        ...
                        className={`w-full h-full aspect-square rounded-lg text-sm font-bold transition-all flex items-center justify-center ${
                          active
                            ...
                            : answered
                            ? "border border-white bg-[rgba(255,255,255,0.08)] text-white shadow-[0_2px_8px_rgba(255,255,255,0.15)]"
                            : "border border-[#E5E5E5] bg-[#F5F5F5] text-[#666666] hover:bg-[#EAEAEA]"
                        }`}
                      >
                        {idx + 1}
                      </button>
                      {isFlagged && (
                        <span className="absolute -top-1.5 -left-1.5 flex h-3.5 w-3.5 z-10 pointer-events-none">
                          <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#888888] opacity-50" />
                          <span className="relative inline-flex h-3.5 w-3.5 rounded-full bg-[#888888] border-2 border-white shadow-md" />
                        </span>
                      )}
                    </div>
                  );
              ...
              <div className="space-y-2 text-sm font-medium text-[#666666] pb-4 border-b border-[#E5E5E5]">
                {[
                  ...
                  <div key={item.label} className="flex items-center gap-2">
                    <div className={`w-3 h-3 rounded box-border ${item.color}`} />
                    ...
                    return (
                      <button
                        ...
                        className={`group w-full rounded-xl border-2 px-4 py-3.5 text-left transition-all sm:px-5 sm:py-4 ${
                          sel
                            ? "border-white bg-[rgba(255,255,255,0.08)] shadow-[0_2px_8px_rgba(255,255,255,0.15)]"
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <p
                            className={`flex-1 text-sm transition-colors ${
                              sel ? "text-white font-semibold" : "text-[#333333]"
                            }`}
                          >
                            {opt.text}
                          </p>
